...
return [
    ...
    */
    ...
    'options' => [
        ...
        'dompdf' => [
            'font_dir' => storage_path('fonts'), // Set a custom font directory
            'temp_dir' => storage_path('temp'), // Set a custom temporary directory
            'chroot' => realpath(base_path()),  // Allow dompdf to access all folders inside the base path
        ],
