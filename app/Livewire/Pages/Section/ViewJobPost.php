...
class ViewJobPost extends Component
{

    use WithFileUploads;

    public $getPost, $loading;
    ...
    {
        $this->title = $title;
        $this->getJobPost($this->title);
    }

    public function getJobPost($title)
    {
        $this->getPost = OpenPositions::where('job-title', $title)->first();
    }
    ...
    {
        return view('livewire.pages.section.view-job-post');
    }
}
