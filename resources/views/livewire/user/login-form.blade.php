            ...
            <div class="card-body">
                ...
                <form wire:submit.prevent="login" role="form">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('auth.reset')}}" class="text-sm">Forgot password?</a>
                    </div>
                ...
                <a class="btn btn-light btn-lg d-flex align-items-center shadow-sm border rounded-pill px-4 py-2 mt-4" href="{{ route('google.redirect')}}">
