<x-layouts.app>
    <section class="bg-white dark:bg-gray-900 ">
        <div class="container flex items-center min-h-screen px-6 py-12 mx-auto">
            <div>
                <p class="text-xl font-medium text-yellow-500 dark:text-yellow-500">500 error</p>
                <h1 class="mt-3 text-2xl font-semibold text-gray-800 dark:text-white md:text-3xl">Internal Server Error</h1>
                <p class="mt-4 text-gray-500 dark:text-gray-400">Sorry, unexpected error try again later.</p>
